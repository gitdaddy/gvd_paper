...
%  \LinesNumbered
  ...
  $events$ := a list of sorted points or sites\;
  \While{$events$ > 0}{
  	let $e$ := the next event in $events$\;
...
\begin{figure}
  ...
  \caption{Sweepline Algorithm
    \protect\subref{fig:sweepA} Place Explanation Here
    \protect\subref{fig:sweepB} Place Explanation Here
    \protect\subref{fig:sweepC} Place Explanation Here
    \protect\subref{fig:sweepD}  %(as in \protect\subref{fig:wavefront6}).
    \protect\subref{fig:sweepE} Place Explanation Here
    \protect\subref{fig:sweepF} Place Explanation Here
  }
  \label{fig:wavefront}
\end{figure}
